...
import { aiSalesPrompts } from '../../mock/data/salesOrders';

export function SalesAIBot() {
        ...
        <Box sx={{ p: 2 }}>
          <Stack direction="row" sx={{ alignItems: 'center', gap: 1, mb: 1.5 }}>
            ...
            <Box sx={{ flex: 1 }}>
              ...
              <Typography sx={{ fontSize: 11, color: 'text.secondary' }}>
                Ask about orders, sales, targets, or draft a report.
              </Typography>
            </Box>
          ...
          >
            <Typography sx={{ fontSize: 12, color: 'text.secondary', lineHeight: 1.5 }}>
              ...
              Sales AI uses your live orders, targets, and POS data.
            </Typography>
          </Box>
