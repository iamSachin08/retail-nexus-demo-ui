...
import { aiLeadPrompts } from '../../mock/data/leadManagement';

export function LeadAIBot() {
        ...
        <Box sx={{ p: 2 }}>
          <Stack direction="row" sx={{ alignItems: 'center', gap: 1, mb: 1.5 }}>
            ...
            <Box sx={{ flex: 1 }}>
              ...
              <Typography sx={{ fontSize: 11, color: 'text.secondary' }}>
                Ask about leads, follow-ups, sources, or draft a reply.
              </Typography>
            </Box>
          ...
          >
            <Typography sx={{ fontSize: 12, color: 'text.secondary', lineHeight: 1.5 }}>
              ...
              Lead AI uses your funnel, source mix, and conversion history.
            </Typography>
          </Box>
